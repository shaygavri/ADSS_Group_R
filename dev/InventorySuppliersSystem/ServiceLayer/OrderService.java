...
public class OrderService {
    ...
    public List<Order> runAutomaticShortageOrders() {
        ...
        for (Product product : shortageProducts) {
            ...
            order.changeStatus(OrderStatus.SENT);
            System.out.println(
                    "Automatic shortage order created. Order ID: " + order.getOrderId() + ", Product ID: " + productId + ", Status: SENT"
            );
            createdOrders.add(order);
            System.out.println(
                    "Automatic periodic order created. Order ID: " + order.getOrderId() + ", Status: SENT"
            );
        }
        return createdOrders;
    }
